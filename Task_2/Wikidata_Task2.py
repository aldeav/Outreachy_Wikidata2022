...
#Function to add hello at the end of the page
...
#Functions for printing authors    
def print_article_authors(qid):
    item = pywikibot.ItemPage(repo, qid)
    item_info = item.get()
    try: 
        item_label = item_info['labels']['en']
...
#Printing a page
print_page(page_outreachy)                

#Adding hello to the end of the page
edit_article(page_outreachy)

#Printing information from Wikidata Sandbox
print("\nInformation of sandbox -")
print_information(wiki_sandbox, qual_print = 1)    #qual_print = 1 prints all the qualifiers

#Loading first 4 articles and printing author information 
scientific_articles = ['Q58093180', 'Q60718800', 'Q68818818', 'Q55967148']
print("Author information in articles -")
